...
/**
 * Renderizador 3D de fases lunares con iluminación y texturas realistas
 */
export class MoonRenderer {
  ...
  * @throws {Error} Si el contenedor no es válido
  ...
  constructor(container: HTMLElement) {
    if (!container) {
      throw new Error('El elemento contenedor es obligatorio')
    }
  ...
  * Inicializa la escena de Three.js
  ...
  /**
  * Crea una textura de estrella con una forma adecuada
   */
  ...
  /**
  * Crea el fondo de campo estelar
   */
  ...
  /**
  * Crea la malla lunar en 3D con geometría detallada
   */
  ...
  /**
  * Crea una textura procedural para la superficie lunar
   *
  * @returns THREE.Texture Textura de la superficie lunar
   */
  ...
  /**
  * Configura la iluminación de las fases lunares
   */
  ...
  /**
  * Configura los controles del ratón para la interacción
   */
  ...
  /**
  * Actualiza la visualización de la fase lunar con una rotación fluida
   *
  * @param date - Fecha cuya fase se mostrará
  ...
  * @throws {Error} Si la fecha no es válida
  ...
  /**
  * Anima la rotación lunar para mostrar la progresión de la fase
   *
  * @param targetPhase - Valor de la fase objetivo (0-1)
   */
  ...
  * Bucle de animación
  ...
  /**
  * Gestiona el cambio de tamaño de la ventana
   */
